    ...
    (function () {
        ...
        Drawwwr.prototype.init = function () {
            ...
            var Artboard = new (function () {
                 ...
                 */
                function _onUnload() {
                    $.get(window.drawwwrData.ajaxPath, {
                        LOGOUT: 'Y'
                    });
                }
                ...
                _.Save = function () {
                    ...
                    $successMessage = jQuery('#dialogSuccess').dialog({
                        ...
                        close: function () {
                            ...
                            localStorage.setItem('DECRYPTED_H5I', '');
                ...
                jQuery(function () {
                    var h5iString = localStorage.getItem('DECRYPTED_H5I'),
                        h5i;

                    if (h5iString !== undefined && h5iString !== 'undefined' && h5iString !== '') {
                        try {
                            h5i = JSON.parse(h5iString);

                            _.importH5i(h5i);

                            _.Layers.List[0].Focus();
                        } catch (error) {
                            console.error(error);
                        }
                    }
                    ...
                    var $import = jQuery('#drawwwrImport');
...
window.addEventListener('beforeunload', function (event) {
    ...
    ajax.open('GET', window.drawwwrData.ajaxPath + '/?LOGOUT=Y', true);
